...
class _ImageGeneratorScreenState extends State<ImageGeneratorScreen>
  ...
  Future<void> _generate() async {
    ...
    try {
      final data = await _api.post('/ai/image/', body: {
        'prompt': prompt,
        'model':  _model,
        'aspect': _aspect,
      });
      ...
      child: _GradientBorderCard(
        ...
        child: Column(
          ...
          children: [
            ClipRRect(
              borderRadius:
                  const BorderRadius.vertical(top: Radius.circular(16.6)),
              child: GestureDetector(
              ...
              child: Column(
                ...
                children: [
                  Text(
                    ...
                    style: const TextStyle(
                        color: _kInk, fontSize: 13, height: 1.4),
                  ),
  ...
  void _confirmDelete(GeneratedImage g) {
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        content: const Text('Removes it from your history.',
            style: TextStyle(color: _kSlate)),
        actions: [
          TextButton(
              ...
              child: const Text('Cancel',
                  style: TextStyle(color: _kSlate))),
          TextButton(
            onPressed: () { Navigator.pop(context); _deleteImage(g); },
            child: const Text('Delete',
                style: TextStyle(color: _kImg1,
                    fontWeight: FontWeight.w800)),
          ),
        ],
      ),
  ...
  void _showFullScreen(GeneratedImage g) {
    Navigator.push(context, MaterialPageRoute(
      builder: (_) => _FullScreenImage(image: g),
    ));
  }
}
