...
Widget build(BuildContext context) {
  ...
  Widget _buildHeader(R res) {
    return Column(
      children: [
        // School logo: animated gradient border around white circle
        _GradientBorderCard(
  ...
  Widget _buildGrid(R res) {
    return GridView.count(
      ...
      children: _roles.asMap().entries.map((e) => _AnimatedTile(
        animation: _tileAnims[e.key],
        child: _RoleCard(
          role:    e.value,
          shimmer: _shimmerCtrl,
            ...
            child: Column(
              ...
              children: [
                ...
                Wrap(
                  ...
                  children: widget.role.perks.take(2).map((p) => Container(
            ...
            children: widget.role.perks.map((p) => Padding(
              ...
              child: Row(children: [
                Container(width: 5, height: 5,
                    decoration: BoxDecoration(
                        color: g.last, shape: BoxShape.circle)),
